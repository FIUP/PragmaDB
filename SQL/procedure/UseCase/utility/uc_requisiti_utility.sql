...
CREATE PROCEDURE insertListRequisiti ( IN CodUC VARCHAR(20), IN ReqL VARCHAR(1000), IN Utente VARCHAR(8)) 
BEGIN
...
CREATE PROCEDURE updateReq_on_delete (IN Cod INT(5), IN Utente VARCHAR(8))
BEGIN
