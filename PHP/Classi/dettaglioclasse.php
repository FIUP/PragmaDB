...
END;
		...
		$heads= ['','PrefixNome:','Nome:','Descrizione:','Utilizzo','ContenutaIn:','Diagramma:','Time:'];
		for($i=1;$i<8;$i++){
...
END;
		...
		$relcl1=mysqli_query($conn, $query1) or fail("Query fallita: ".mysqli_error($conn));
		$relcl2=mysqli_query($conn, $query2) or fail("Query fallita: ".mysqli_error($conn));
