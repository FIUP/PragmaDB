			...
			<div id="content">
				...
				<div class="widget-area-left secondary" role="complementary">
					<aside id="export" class="widget">
						...
						<ul>
							<li><a class="link-color-pers" href="$absurl/Package/LaTeX/getpackageclassist.php">Package/Classi ST</a></li>
							<li><a class="link-color-pers" href="$absurl/Package/LaTeX/getpackageclassidpfe.php">Package/Classi DP</a></li>
